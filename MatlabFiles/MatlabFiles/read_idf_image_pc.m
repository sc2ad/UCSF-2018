function output = read_idf_image_pc(rootname, directory, displayflag, byte_order)
%
...
if (nargin < 2)
    error('Not enough input arguments --- must give directory where idf files are stored');
end
...
output.idf = readidf_file_pc(rootname, directory);
